...
This script also models the effects of the valve, so a log needs to be used where the valve was moved. The `grass-80to100-valve.csv` log is a good example.
